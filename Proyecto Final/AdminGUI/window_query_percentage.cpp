...
#include "ui_window_query_percentage.h"
#include "library.h"
#include "socketadmin.h"

window_query_percentage::window_query_percentage(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::window_query_percentage)
{
    ui->setupUi(this);
...
window_query_percentage::~window_query_percentage()
{
    delete ui;
}

void window_query_percentage::on_start_clicked()
{
    QJsonObject ob;
    ob.insert("Pasillo","");
...
void window_query_percentage::on_pasilloButton_clicked()
{
    ui->halls->setEnabled(false);
    ui->pasilloButton->setEnabled(false);
...
void window_query_percentage::on_prodButton_clicked()
{
    ui->prods->setEnabled(false);
    ui->prodButton->setEnabled(false);
...
void window_query_percentage::on_marcaButton_clicked()
{
    ...
    ui->listWidget->addItem(QJsonValue::fromVariant(ob.take("Porcentaje")).toString());

}

void window_query_percentage::on_pushButton_clicked()
{
    hide();
}

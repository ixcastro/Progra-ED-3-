...
//int main(){
//    AVLTree *avl = new AVLTree();
//    avl->insert(new Product(20,"Arroz"));
//    avl->insert(new Product(45,"Cloro"));
//    avl->insert(new Product(34,"Frijoles"));
//    avl->insert(new Product(28,"Jugos"));
//    avl->insert(new Product(73,"Jamones"));
//   // avl->insert(new Product(20,"Sal"));

//    avl->show(avl->getRoot());
//    cout<<"raiz " << avl->getRoot()->getProduct()->getCode()<<endl;

//    avl->deleteAVLData(20);
//    cout<<endl;
//    cout<<"-------------"<<endl;
//    cout<<endl;

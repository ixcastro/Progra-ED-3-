...
string ListaReserva::InsertarFinal(string pComprador, string pCodTipoTren, string pCodTren, string pCodRuta, string pPasajeros, string pNumAsientos, string *pPasaportes)
{
   if (ListaVacia()){
     ...
     { pnodoReserva aux = primero;
        ...
        aux->siguiente->asignarPasaportes(pPasaportes);

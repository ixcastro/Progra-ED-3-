...
void Grafo::dijkstra(string pDataS, string pDataF){
    ...
    allData = allData + "--------------------------------------" +"\n";
    allData = allData + "EL PESO DEL CAMINO MAS CORTO ES : " +ml.int2str(getFinal()[pFinal])+"\n";
    allData = allData + "--------------------------------------" +"\n";
    ...
    allData = allData + "--------------------------------------" +"\n";
    allData = allData + "EL RECORRDIO DE VERTICES ES :" +"\n";
...
//    allData = allData+"\n";
//    allData = allData+"\n";
    allData = allData+"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"+"\n";
    allData = allData+"            TABLA FINAL              "+"\n";
//    allData = allData+"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"+"\n";
    allData = allData+"--------------------------------------"+"\n";
    allData = allData+"   CIUDAD  |  FINAL   |   TEMP     "+"\n";
    allData = allData+"--------------------------------------"+"\n";
    ...
    for(int i=0; i < pFinal.size(); i++){
        ...
        allData = allData+"     "+cities[i]->getName().toStdString()+
                "     |     "+ml.int2str(pFinal[i])+"    |    "+ml.int2str(pTemp[i])+"    "
                +"\n";
        allData = allData+"--------------------------------------"+"\n";
...
//    allData = allData+"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"+"\n";
//    allData = allData+"\n";
//    allData = allData+"\n";
...
void Grafo::getAdyacenteInverso(){
    ...
    for(int j=0; j < pTemp.size(); j++){
        // con pos anclado busca adyacentes
        if (getConnections()[pPos][j] != 0){
            if( pFinal[pPos] -  getConnections()[pPos][j] ==  pFinal[j] || pFinal[pPos] -  getConnections()[pPos][j] ==  0){
...
bool Grafo::dExist(string pData){

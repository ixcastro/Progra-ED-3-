...
#include "ui_window_modify_price.h"
#include "library.h"
#include "socketadmin.h"

window_modify_price::window_modify_price(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::window_modify_price)
{
    ui->setupUi(this);
...
window_modify_price::~window_modify_price()
{
    delete ui;
}

void window_modify_price::on_start_clicked()
{
    QJsonObject ob;
    ob.insert("Pasillo","");
...
void window_modify_price::on_pasilloButton_clicked()
{
    ui->halls->setEnabled(false);
    ui->pasilloButton->setEnabled(false);
...
void window_modify_price::on_prodButton_clicked()
{
    ui->prods->setEnabled(false);
    ui->prodButton->setEnabled(false);
...
void window_modify_price::on_marcaButton_clicked()
{
...
void window_modify_price::on_back_clicked()
{
    hide();
}

void window_modify_price::on_save_clicked()
{
    if (ui->lineEdit->text() == "" ){
        ...
        recordObjects.insert("Iprecio",QJsonValue::fromVariant(ui->lineEdit->text().toInt()));

        QJsonObject record;
        record.insert("newPrecio",recordObjects);

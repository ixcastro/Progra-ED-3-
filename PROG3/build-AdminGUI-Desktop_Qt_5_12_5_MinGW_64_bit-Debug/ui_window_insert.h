...
public:
    ...
    void setupUi(QMainWindow *window_insert)
    {
        ...
        window_insert->resize(479, 567);
        centralwidget = new QWidget(window_insert);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        back = new QPushButton(centralwidget);
        back->setObjectName(QString::fromUtf8("back"));
        back->setGeometry(QRect(20, 470, 171, 41));
        ...
        solicitudes = new QPushButton(centralwidget);
        solicitudes->setObjectName(QString::fromUtf8("solicitudes"));
        solicitudes->setGeometry(QRect(20, 380, 441, 71));
    ...
    void retranslateUi(QMainWindow *window_insert)
    {
        ...
        solicitudes->setText(QApplication::translate("window_insert", "Aceptar solicitudes", nullptr));
    } // retranslateUi

...
public:
    ...
    nodoTren(int pCodTren,string pNombre, string pnumAsientos, string pCodCiudadSalida, string pCodPaisSalida, nodoTren *der = NULL, nodoTren *izq = NULL, nodoTren *sig=NULL, nodoTren *ant=NULL, NodoRuta *pRutas = NULL):
    ...
    string Nombre;
    string numAsientos;
    string CodCiudadSalida;
    string CodPaisSalida;

...
public:
    ...
    //////////////////////////////////////////////////////////////////////////////
    bool BuscarRuta(int pCodTipoTren, int pCodTren, string pCodPaisSalida, string pCodCiudadSalida, string pCodPaisDestino, string pCodCiudadDestino);
    bool BuscarRutaDijsktra(string pCodPaisSalida, string pCodCiudadSalida, string pCodPaisDestino, string pCodCiudadDestino);

    void BuscarTipoTrenRuta(nodoTipoTren *R, int pCodTipoTren, int pCodTren, string pCodPaisSalida, string pCodCiudadSalida, string pCodPaisDestino, string pCodCiudadDestino);
    void BuscarTrenParaRuta(nodoTren *R, int pCodTren, string pCodPaisSalida, string pCodCiudadSalida, string pCodPaisDestino, string pCodCiudadDestino);
    void BuscarRutaValidar(pnodoRuta R, string pCodPaisSalida, string pCodCiudadSalida, string pCodPaisDestino, string pCodCiudadDestino);

    void BuscarTipoTrenRutaDijsktra(nodoTipoTren *R, string pCodPaisSalida, string pCodCiudadSalida, string pCodPaisDestino, string pCodCiudadDestino);
    void BuscarTrenParaRutaDijsktra(nodoTren *R, string pCodPaisSalida, string pCodCiudadSalida, string pCodPaisDestino, string pCodCiudadDestino);

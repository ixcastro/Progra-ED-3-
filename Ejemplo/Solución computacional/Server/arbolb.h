...
public:
    ArbolB (int numClave);
    string buscar (string clave);                    // retorna la posición del número si este fue encontrado
    string validarEstadoMigratorio (string codUsuario);
    string modificarEstadoMigratorio (string pPasaporte, int nuevoEM);
